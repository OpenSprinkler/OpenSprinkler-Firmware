...
<table border=1 cellspacing=4 id='rd'>
<tr><td align='center'><b>Detected SSID</b></td><td align='center'><b>BSSID</b></td><td align='center'><b>Strength</b></td>
...
if(id('bssid').value.length>0 && id('channel').value.length>0)
comm+='&extra='+encodeURIComponent(id('bssid').value+'@'+id('channel').value);
