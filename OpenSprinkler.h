...
public:
	...
	static int8_t send_http_request(uint32_t ip4, uint16_t port, char* p, void(*callback)(char*)=NULL, uint16_t timeout=5000, int ntries=3);
	static int8_t send_http_request(const char* server, uint16_t port, char* p, void(*callback)(char*)=NULL, uint16_t timeout=5000, int ntries=3);
	static int8_t send_http_request(char* server_with_port, char* p, void(*callback)(char*)=NULL, uint16_t timeout=5000, int ntries=3);

	static int8_t send_https_request(uint32_t ip4, uint16_t port, char* p, void(*callback)(char*)=NULL, uint16_t timeout=5000, int ntries=3);
	static int8_t send_https_request(const char* server, uint16_t port, char* p, void(*callback)(char*)=NULL, uint16_t timeout=5000, int ntries=3);
	static int8_t send_https_request(char* server_with_port, char* p, void(*callback)(char*)=NULL, uint16_t timeout=5000, int ntries=3);
