...
#define MAX_PROGRAMMED_DURATION 64800UL // maximum stored/manual/remote-command duration (18 hours)
#define MAX_RUNTIME_DURATION 65535UL // maximum effective duration representable by RuntimeQueueStruct
