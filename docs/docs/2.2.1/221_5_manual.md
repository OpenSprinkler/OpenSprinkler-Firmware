...
* For details on the sensor log data formats and API-based retrieval, refer to the [OpenSprinkler API documentation](221_5_api.md#get-expanded-sensor-log-jsl).
