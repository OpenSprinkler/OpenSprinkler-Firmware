...
| <span class="hl">`8`</span> | <span class="hl">`uint32`</span> | <span class="hl">`aux`</span> | <span class="hl">Flow in hundredths of GPM for station records, or the special event's first numeric value.</span> |
