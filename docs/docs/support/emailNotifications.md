...
OpenSprinkler sends email notifications using a user-selected **SMTP** (Simple Mail Transfer Protocol) server, such as [Gmail](www.gmail.com) or [Zoho](www.zoho.com/mail).
